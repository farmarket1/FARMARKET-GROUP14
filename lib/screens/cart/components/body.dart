...
import '../../../services/database/order_database_helper.dart';
import '../../../utils.dart';
...
class _BodyState extends State<Body> {
  ...
  Future<void> checkoutButtonCallback() async {
    ...
    final confirmation = await showConfirmationDialog(
      context,
      "Do you want to proceed with the above order?",
    );
    ...
    orderFuture.then((orderedProductsUid) async {
      if (orderedProductsUid != null) {
        ...
        try {
          addedProductsToMyProducts = await OrderDatabaseHelper()
              .addToMyOrders(orderedProducts, _position);
